...
print("This is a holiday themed hangman. Try to find the word based of the dificulty you choose")
...
dffclty = input('Choose difficulty type (type 1, 2, or 3)\n 1 Easy\n 2 Normal\n 3 Hard\n : ')
dffclty = int(dffclty)
...
if gssd_wrd_crrctly is True:
    print('Merry Christmas, You Won! the word was ' + scrt_wrd)
else:
